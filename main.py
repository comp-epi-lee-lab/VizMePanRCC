...
if search_pressed == True:
    if cg_value not in table.columns:
        ...
        if age:
            ...
            rcc_50 = df.loc[(df["age_at_initial_pathologic_diagnosis"] >= 20) & (df["age_at_initial_pathologic_diagnosis"] < 50) & (df["rcc"] == "rcc"), cg_value].dropna()
            normal_50 = df.loc[(df["age_at_initial_pathologic_diagnosis"] >= 20) & (df["age_at_initial_pathologic_diagnosis"] < 50) & (df["rcc"] == "normal"), cg_value].dropna()
            ...
            under50_rcc_count = (((df['age_at_initial_pathologic_diagnosis'] >= 20) &( df['age_at_initial_pathologic_diagnosis'] < 50)) & (df['rcc'] == 'rcc')).sum()
            under50_normal_count = (((df['age_at_initial_pathologic_diagnosis'] >= 20) & (df['age_at_initial_pathologic_diagnosis'] < 50)) & (df['rcc'] == 'normal')).sum()
            ...
            mean_values_rcc = [under50_rcc_mean, under60_rcc_mean, under70_rcc_mean, over70_rcc_mean]
            mean_values_normal = [under50_normal_mean, under60_normal_mean, under70_normal_mean, over70_normal_mean]
            labels = ["20-49<br>(N = " + str(under50_normal_count) + "|" + str(under50_rcc_count) + ")", "50-59<br>(N = " + str(under60_normal_count) + "|" + str(under60_rcc_count) + ")", "60-69<br>(N = " + str(under70_normal_count) + "|" + str(under70_rcc_count) + ")", "70+<br>(N = " + str(over70_normal_count) + "|" + str(over70_rcc_count) + ")"]            
            fig = go.Figure()
